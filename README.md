...
- ![Crates.io Version](https://img.shields.io/crates/v/pkloong-kcapi-sys)
  ![Crates.io Dependents](https://img.shields.io/crates/dependents/pkloong-kcapi-sys)
  ![Crates.io Total Downloads](https://img.shields.io/crates/d/pkloong-kcapi-sys)\
...
- ![Crates.io Version](https://img.shields.io/crates/v/pkloong-kcapi)
  ...
  `pkloong-kcapi`：更安全、易用的高层 API（消息杂凑值/鉴别码/随机数）。\
  `pkloong-kcapi`: safer high-level API (Digest/HMAC/RNG).
